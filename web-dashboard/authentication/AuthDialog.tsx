    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex md:w-5/12 flex-col justify-between bg-black text-white p-10 relative overflow-hidden">
          {/* decorative blobs */}
          <div className="absolute bottom-0 left-0 w-56 h-56 rounded-full nc-bg-accent opacity-20 blur-3xl pointer-events-none" />
          <div className="absolute top-0 right-0 w-32 h-32 rounded-full nc-bg-accent-20 opacity-10 blur-2xl pointer-events-none" />
          ...
          <div className="flex-1 p-8 md:p-10 flex flex-col justify-center">
            ...
            >
                  ...
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    {mode === "login" && (
                      <button
                        ...
                        className="text-xs nc-accent hover:opacity-90 font-medium"
                      >
                        Forgot password?
                      </button>
                    )}
              ...
              <button
                ...
                className="mt-1 w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg nc-btn-accent text-sm font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
              ...
              {mode === "login" && (
                <>
                  ...
                  <button
                    ...
                    className="nc-accent hover:opacity-90 font-medium"
                  >
                    Sign up free
                  </button>
                </>
