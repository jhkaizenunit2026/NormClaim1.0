...
function GlassFilter({ id }: { id?: string }) {
  return (
    <svg className="absolute -z-10 h-0 w-0" aria-hidden="true" style={{ position: "absolute", width: 0, height: 0 }}>
      <defs>
        <filter
          id={id || "container-glass"}
          x="0%"
          y="0%"
          width="100%"
          height="100%"
